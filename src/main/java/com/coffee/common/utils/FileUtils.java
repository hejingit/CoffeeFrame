...
public class FileUtils extends org.apache.commons.io.FileUtils {
	...
	public static String uploadFile(MultipartFile file, String orgId) throws IllegalStateException, IOException {
		String absolutePath = "";
		String userfilesBaseURL = "";
		String origFileName = "";
		if (orgId != null && orgId.length() > 0 && file != null&&file.getSize()>0) {
			origFileName=file.getOriginalFilename();
			String realPath = Global.USERFILES_BASE_URL + "/orginfo/" + orgId + "/images/";
			FileUtils.createDirectory(Global.getUserfilesBaseDir() + realPath);
			String newFileName = IdGen.randomBase62(6) + "_" + System.currentTimeMillis()
					+ origFileName.substring(origFileName.lastIndexOf("."));

			absolutePath = Global.getUserfilesBaseDir() + realPath + newFileName;
			userfilesBaseURL = realPath + newFileName;
