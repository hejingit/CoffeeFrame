package com.coffee.common.mail;
/**   
 * 简单邮件（不带附件的邮件）发送器   
 */ 
...
/**   
  ...
  */    
    ...
    public static void main(String[] args) {
    	...
    	String PORT="25";
    	String EMAIL="service@coffee-ease.com";
    	String PAW="Geotmt.231";
    	String toEMAIL="yuanyingsheng@coffee-ease.com";
    	String TITLE="注册邮箱激活";
    	String CONTENT="把以下链接复制到浏览器打开<br/>http://localhost:8080/a?active&loginName=yuanyingsheng@coffee-ease.com&verifyCode=9b7462cdd0834f179129aeb27159cf9d";
    	
		MailSendUtils.sendEmail(SMTP, PORT, EMAIL, PAW, toEMAIL, TITLE, CONTENT, "2");
	}
