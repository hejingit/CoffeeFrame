...
import com.coffee.common.beanvalidator.BeanValidators;
...
import com.coffee.common.utils.excel.ExportExcel;
import com.coffee.common.utils.excel.ImportExcel;
...
import com.coffee.modules.sys.service.SystemConfigService;
import com.coffee.modules.sys.service.SystemService;
import com.coffee.modules.sys.utils.UserUtils;
import com.coffee.modules.tools.utils.TwoDimensionCode;
...
//		EducationOrg eduOrg=educationOrgService.getByPcOrgId(UserUtils.getPrincipal().getOrgId());
//		model.addAttribute("eduOrg",eduOrg);
...
//				currentUser.setPhoto(user.getPhoto());
	...
	/**
	 * web端ajax验证email是否可以注册（数据库中不存在）
	 */
	@ResponseBody
	@RequestMapping(value = "validateEmail")
	public boolean validateEmail(String email, HttpServletResponse response, Model model) {
