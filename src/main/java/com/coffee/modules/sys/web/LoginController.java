...
import com.coffee.common.security.shiro.session.SessionDAO;
import com.coffee.common.servlet.ValidateCodeServlet;
import com.coffee.common.utils.CacheUtils;
import com.coffee.common.utils.CookieUtils;
...
import com.coffee.modules.sys.security.FormAuthenticationFilter;
...
//		}
	...
	public String logout(HttpServletRequest request, HttpServletResponse response, Model model) throws IOException {
		...
		if(principal != null){
			...
			UserUtils.clearCache(UserUtils.get(principal.getId()));
		}
	...
	public String index(HttpServletRequest request, HttpServletResponse response,Model model) {
		...
		//判断用户是否还未提交资料，未提交则直接跳转到提交资料页面
		User user = UserUtils.getUser();
		String defaultCompanyId = Global.getProperties().getProperty("registered.user.default.companyid");
		if(user.getCompany() != null && defaultCompanyId.equals(user.getCompany().getId())) {
...
//		try {
//			byte[] bytes = com.coffee.common.utils.FileUtils.readFileToByteArray(
//					com.coffee.common.utils.FileUtils.getFile("c:\\sxt.dmp"));
