...
<%@page import="com.coffee.common.utils.Exceptions"%>
<%@page import="com.coffee.common.utils.StringUtils"%>
...
<head>
	...
	<script src="${ctxStatic}/static/jquery/jquery-2.1.1.min.js" type="text/javascript"></script>
...
<body class="gray-bg">
    ...
    <h1><img src="${ctxStatic}/common/img/400.png" /></h1>
