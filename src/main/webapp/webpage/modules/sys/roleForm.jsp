...
<body class="hideScroll">
	<form:form id="inputForm" modelAttribute="role" autocomplete="off" action="${ctx}/sys/role/save" method="post">
		...
		<form:hidden path="office.id" value="${role.office.id}" />
		<sys:message content="${message}"/>
		<div class="dialog-coffee-table">
		<table class="table table-bordered">
		   <tbody>
		      <tr>
		 <%--         <td class="width-15 active"><label class="table-label">归属机构</label></td>
		         <td class="width-35"> 
		         ...
		         <td  class="width-15 active"><label class="table-label"><font color="red">*</font>角色名称</label></td>
				...
				<td class="width-15 active"><label class="table-label"><font color="red">*</font>英文名称</label></td>
		      ...
		      <tr>
				...
				<%-- 
				<td  class="width-15 active"><label class="table-label">角色类型</label></td>	
				         <td class="width-35">
					<form:input path="roleType" htmlEscape="false" maxlength="50" class="input-text required"/>
					...
					<form:select path="roleType" class="input-text">
		      ...
		      <tr>
		         <td class="width-15 active"><label class="table-label">是否系统数据</label></td>
		         <td class="width-35"><form:select path="sysData" class="input-text">
		         ...
		         <td class="width-35"><form:select path="useable" class="input-text">
					<form:options items="${fns:getDictList('yes_no')}" itemLabel="label" itemValue="value" htmlEscape="false"/>
					</form:select>
					<span class="help-inline">“是”代表此数据可用，“否”则表示此数据不可用</span></td>
		      </tr>
		      <tr>
		         <td class="width-15 active"><label class="table-label">数据范围</label></td>
		         <td class="width-35"><form:select path="dataScope" class="input-text">
					<form:options items="${fns:getDictList('sys_data_scope')}" itemLabel="label" itemValue="value" htmlEscape="false"/>
					</form:select>
					<span class="help-inline">特殊情况下，设置为“按明细设置”，可进行跨机构授权</span>
					<div class="controls" style="margin: 15px 0 0;">
