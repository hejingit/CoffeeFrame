...
<head>
    ...
    <style type="text/css">
			...
			.the-icons li {float:left;width:23%;line-height:25px;margin:5px 5px;cursor:pointer;}
			.the-icons i {margin:1px 5px;font-size:16px;vertical-align: top;}
			.the-icons li:hover {background-color:#efefef;}
			.the-icons li.active {background-color:#33acca;color:#ffffff;}
...
<div id="icons">
				<h2 class="page-header">Coffee Icons</h2>
				<ul class="the-icons">
			       <li class="fa-hover col-md-3 col-sm-4"><i class="fa coffee-default"></i>默认图标</li>
			       <li class="fa-hover col-md-3 col-sm-4"><i class="fa coffee-01"></i>我的面板</li>
			       <li class="fa-hover col-md-3 col-sm-4"><i class="fa coffee-02"></i>系统设置</li>
			       <li class="fa-hover col-md-3 col-sm-4"><i class="fa coffee-03"></i>系统监控</li>
			       <li class="fa-hover col-md-3 col-sm-4"><i class="fa coffee-04"></i>申请码管理</li>
			       <li class="fa-hover col-md-3 col-sm-4"><i class="fa coffee-05"></i>保证金管理</li>
			       <li class="fa-hover col-md-3 col-sm-4"><i class="fa coffee-06"></i>退费管理</li>
			       <li class="fa-hover col-md-3 col-sm-4"><i class="fa coffee-07"></i>降班管理</li>
			       <li class="fa-hover col-md-3 col-sm-4"><i class="fa coffee-08"></i>贷款订单查询</li>
			       <li class="fa-hover col-md-3 col-sm-4"><i class="fa coffee-09"></i>常用工具</li>
			       <li class="fa-hover col-md-3 col-sm-4"><i class="fa coffee-10"></i>分期业务</li>
			       <li class="fa-hover col-md-3 col-sm-4"><i class="fa coffee-11"></i>对账查询</li>
			       <li class="fa-hover col-md-3 col-sm-4"><i class="fa coffee-12"></i>逾期查询</li>
			       <li class="fa-hover col-md-3 col-sm-4"><i class="fa coffee-13"></i>产品分类管理</li>
			       <li class="fa-hover col-md-3 col-sm-4"><i class="fa coffee-14"></i>产品分类管理</li>
			    </ul>
