...
<meta name="author" content="http://www.coffee-ease.com.cn"/>
...
<script src="${ctxStatic}/dataTables/js/jquery.dataTables.min.js"></script>
<script src="${ctxStatic}/dataTables/js/dataTables.bootstrap.min.js"></script>

<!-- coffee -->
<link href="${ctxStatic}/common/coffeebase.css" type="text/css" rel="stylesheet" />
<script src="${ctxStatic}/common/coffeebase.js" type="text/javascript"></script>
