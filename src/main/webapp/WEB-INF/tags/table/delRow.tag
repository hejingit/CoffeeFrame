...
<button class="btn btn-sm btn-primary btn-inquire" onclick="deleteAll()" data-toggle="tooltip" data-placement="left" title="删除"><i class="fa fa-trash-o"> ${label==null?'删除':label}</i>
                        </button>
